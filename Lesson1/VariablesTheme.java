public class VariablesTheme {
    public static void main(String[] args) {
        ...
        System.out.println("Минимальное число типа byte + 1 : " + ++byteMaxMinValue);
        System.out.println("Минимальное число типа short + 1 : " + ++shortMaxMinValue);
        System.out.println("Минимальное число типа int + 1: " + ++intMaxMinValue);
        System.out.println("Минимальное число типа long + 1: " + ++longMaxMinValue);
        System.out.println("Минимальное число типа float + 1: " + ++floatMaxMinValue);
        System.out.println("Минимальное число типа double + 1: " + ++doubleMaxMinValue);
        System.out.println("Минимальное число типа char + 1: " + ++charMaxMinValue);
        System.out.println("Максимальное число типа byte : " + --byteMaxMinValue);
        System.out.println("Максимальное число типа short : " + --shortMaxMinValue);
        System.out.println("Максимальное число типа int : " + --intMaxMinValue);
        System.out.println("Максимальное число типа long : " + --longMaxMinValue);
